...
package_name="pager100-lora-bridge"
archs="amd64 arm64"
depends="device-manager-msgs device-manager ros-jazzy-rmw-cyclonedds-cpp ros-jazzy-rclcpp ros-jazzy-std-msgs"
...
print(json.dumps({
    ...
    "description": "PG100 pager vehicle-side LoRa serial bridge for ROS 2 Jazzy",
    "stage_dir": "install-pager100-lora-bridge",
    "ros_packages": ["pager100_lora_bridge"],
}, ensure_ascii=False))
PY
